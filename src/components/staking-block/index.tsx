...
const StakingBlock: FunctionalComponent = () => {
    return (
        <div className={`${style.staking} ${style.container}`}>
            <div className={`${style.staking__container}`}>
                <div className={`${style['staking__container_block_1']}`}>
                    <div>
                        ...
                        <section className={style['staking__buttons']}>
                            <a
                                className={`${style['staking__buttons-order']} ${style.btn} ${style['btn-orange']} ${style['btn-rounded']}`}
                            >
                                ORDER STAKING
